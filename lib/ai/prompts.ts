...
export const looplyBusinessPrompt = `
Looply business tools are available for customer intelligence, analytics, campaign drafting, campaign approval, real knowledge retrieval, and preference memory.
